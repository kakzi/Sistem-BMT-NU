    ...
    return (
        ...
        <div className="sb-sidenav-menu">
            ...
            {(hasAnyPermission(["categories.index"]) ||
                ...
                hasAnyPermission(["careers.index"]) ||
                hasAnyPermission(["layanans.index"]) ||
                hasAnyPermission(["finances.index"]) ||
                hasAnyPermission(["ziswafs.index"]) ||
                hasAnyPermission(["savings.index"]) ) && (
                <>
                ...
                <a
                    ...
                    (activeRoute[2] === "categories"
                        ...
                        ? " active-sidebar"
                        : activeRoute[2] === "careers"
                        ? " active-sidebar"
                        : activeRoute[2] === "layanans"
                        ? " active-sidebar"
                        : activeRoute[2] === "finances"
                        ? " active-sidebar"
                        : activeRoute[2] === "ziswafs"
                        ? " active-sidebar"
                        : activeRoute[2] === "savings"
                        ? " active-sidebar"
                        : "")
                    }
                    href="#"
